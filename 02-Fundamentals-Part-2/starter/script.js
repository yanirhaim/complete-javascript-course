...
const calAge2  = function (date) {console.log(2023 - date)};
calAge2(2000);

//Arrow function
const calcAge3 = birthyear => console.log(2037 - birthyear);
calcAge3(2000);

const yearDifference = (first, second) => first - second;
console.log(yearDifference(23,20));
...
// Arrays 
const friends = ['Juan', 'Pepe', 'Pablito'];
let years = new Array(2000,2001,2003,2004);
...
values (bill + tip) for every bill value in the bills array. Use a for loop to perform the 10 calculations!
